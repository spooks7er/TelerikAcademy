...
// var movie = module.getMedia('The Matrix', 5, 255, 'Action', 'Baddas movie about the future');
...
// catalog.add([someobj, secondobj, obj3]);

// //console.log(catalog.items)

// //console.log(catalog.find(12));
...
// console.log(catalog.getSortedByDuration());

// // console.log(catalog.find({
// //     genre: 'Horror'
// // }));
// // console.log('-----------------------------------')
// // console.log(catalog.search('qwe'));
