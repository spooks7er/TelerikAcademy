...
describe('Tests for "Task 1"', function() {
	...
	describe('Test for exist correct type ', function() {
		it('1 expect domElement to be an object', function() {
			expect(domElement).to.be.a('object');
		});
		it('2 expect domElement.init to be a function', function() {
			expect(domElement.init).to.be.a('function');
		});
		it('3 expect domElement.appendChild to be a function', function() {
			expect(domElement.appendChild).to.be.a('function');
		});
		it('4 expect domElement.addAttribute to be a function', function() {
			expect(domElement.addAttribute).to.be.a('function');
		});
		it('5 expect domElement.removeAttribute to be a function', function() {
			expect(domElement.removeAttribute).to.be.a('function');
		});
	});

	describe('Sanity checks', function() {
		it('6 expect domElement with empty type to throw', function() {
			function test() {
				Object.create(domElement).init('');
			}
			expect(test).to.throw();
		});
		it('7 expect domElement with type not a string to throw', function() {
			function test() {
				Object.create(domElement).init(42);
			}
			expect(test).to.throw();
		});
		it('8 expect domElement with type containing bad characters to throw', function() {
			function test() {
				Object.create(domElement).init('hello!');
			}
			expect(test).to.throw();
		});
		it('9 expect domElement with valid type not to throw', function() {
			function test() {
		...
		it('10 expect adding attribute with empty name to throw', function() {
			function test() {
		...
		it('11 expect adding attribute with name containing bad characters to throw', function() {
			function test() {
				var root = Object.create(domElement)
					.init('whatever')
		...
		it('12 expect adding attribute with valid name not to throw', function() {
			function test() {
				var root = Object.create(domElement)
					.init('whatever')
		...
		it('13 expect removing non-existent attribute to throw', function() {
			function test() {
				var root = Object.create(domElement)
					.init('td')
		...
		it('14 expect removing non-existent attribute to throw', function() {
			function test() {
				var root = Object.create(domElement)
					.init('td')
		...
		it('15 expect removing existent attribute not to throw', function() {
			function test() {
				var root = Object.create(domElement)
					.init('td')
					.addAttribute('rowsomething', 'has a value')
	...
	describe('Adding attributes', function() {
		it('16 expect empty domElement to generate correct HTML', function() {
			var type = 'html',
		...
		it('17 expect domElement with a single attribute to generate correct HTML', function() {
			var root = Object.create(domElement)
				.init('div')
		...
		it('18 expect attribute value to be in double quotes when it is a number', function() {
			var root = Object.create(domElement)
				.init('whateverTag')
				.addAttribute('something', 42);
			expect(root.innerHTML).to.eql('<whateverTag something="42"></whateverTag>');
		});
		it('19 expect domElement with attributes to generate HTML with the attributes in correct order', function() {
			var root = Object.create(domElement)
				.init('NqmaTakufTag')
		...
		it('20 expect repeating attribute name to hold only the last value', function() {
			var root = Object.create(domElement)
				.init('theGuiltyTag')
	...
	describe('Parent control', function() {
		it('21 expect children to know their parents (one parent, one child)', function() {
		...
		it('22 expect children to know their parents (one parent, two children)', function() {
		...
		it('23 expect children to know their parents (grandparent, parent and child)', function() {
	...
	describe('Adding children', function() {
		it('24 expect correct HTML when child is a string', function() {
		...
		it('25 expect correct HTML with nested domElements (one parent, one child)', function() {
			var child = Object.create(domElement)
					.init('child'),
				parent = Object.create(domElement)
					.init('parent')
		...
		it('26 expect correct HTML with nested domElements (one parent, two children)', function() {
		...
		it('27 expect correct HTML with nested domElements (grandparent, parent and child)', function() {
			var child = Object.create(domElement).init('child'),
				middle = Object.create(domElement)
					.init('middleBlq')
					.appendChild(child);
		...
		it('28 expect correct HTML when adding content', function() {
			var text = 'Some text here, doesn\'t really matter that much what it is.',
				root = Object.create(domElement).init('p');
			root.content = text;
			expect(root.innerHTML).to.eql('<p>' + text + '</p>');
		});
		it('29 expect string children to override parent\'s content', function() {
			var text = 'see me',
				parent = Object.create(domElement)
					.init('parent')
					.appendChild(text);
		...
		it('30 expect domElement children to override parent\'s content', function() {
			var child = Object.create(domElement)
					.init('child'),
				parent = Object.create(domElement)
					.init('parent')
		...
		it('31 expect correct HTML when having both string and domElement children', function() {
		...
		it('32 expect correct HTML, when there are attributes with same names, but in different domElements', function() {
			var child = Object.create(domElement)
					.init('child')
					.addAttribute('id', 'cid'),
				parent = Object.create(domElement)
	...
	describe('Removing attributes', function() {
		it('33 expect removing an attribute to work (removing the only attribute)', function() {
			var root = Object.create(domElement)
				.init('table')
		...
		it('34 expect removing an attribute to work (removing one of the attributes)', function() {
			var root = Object.create(domElement)
				.init('table')
				.addAttribute('style', 'something: beautiful')
		...
		it('35 expect removing an attribute to work (removing attribute that was added twice)', function() {
			var root = Object.create(domElement)
				.init('table')
		...
		it('36 expect removing an attribute to work (removing an attribute and then adding it again)', function() {
			var root = Object.create(domElement)
				.init('table')
				.addAttribute('class', 'word')
				.removeAttribute('class')
		...
		it('37 expect removing an attribute to work (nested domElements)', function() {
		...
		it('38 expect removing an attribute to work (nested domElements)', function() {
			var parent = Object.create(domElement)
				.init('html')
				.addAttribute('id', 'myindex.html');
			var child = Object.create(domElement)
		...
		it('39 expect removing an attribute to work (nested domElements)', function() {
			var parent = Object.create(domElement)
				.init('html')
				.addAttribute('id', 'myindex.html');
			var child = Object.create(domElement)
	...
	describe('Mixing it all together', function() {
		it('40 expect the example test given in the description to work', function() {
		...
		it('41 expect this big test to work (no removeAttribute)', function() {
		...
		it('42 expect this big test to work', function() {
			var style = Object.create(domElement)
					.init('style')
					.appendChild('#big {\nfont-size: 144pt;\n}'),
				link = Object.create(domElement)
