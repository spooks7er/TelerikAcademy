...
class AssertionsHomework
{
    ...
    {
        Debug.Assert(arr.Length > 1, "Array must have length bigget than 1");
    ...
    {
        Debug.Assert(startIndex + endIndex - startIndex <= arr.Length, "startIndex and endIndex must be within the bounds of the array");
